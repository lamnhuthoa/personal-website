...
export default function Professional() {
    return (
        <div className="work-exp-container">
            <h3 className="text-center work-exp-title">Professional Experiences</h3>
            <div className="work-exp-job-container">
                <div className="work-exp-job-content">
                    <div className="work-exp-job-item">
            ...
            <h3 className="text-center work-exp-title pt-4">Other Experiences</h3>
            <div className="work-exp-job-container">
                <div className="work-exp-job-content">                    
                    <div className="work-exp-job-item">
                        <div className="work-exp-job-info">
