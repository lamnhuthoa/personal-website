                ...
                <div className="work-exp-job-content">
                    <div className="work-exp-job-item item--1">
                        ...
                        <div className="work-exp-job-image">
                            <img src="./img/dxc-logo.png" alt="dxc-logo"/>
                        </div>
                    </div>
                    <hr/>
                    <div className="work-exp-job-item item--2">
                        <div className="work-exp-job-info">
                            ...
                            <ul>
                                <li>Managed employee's database and maintained the Access Control System.</li>
                                <li>Managed database for internal tool - Space Management System.</li>
                                <li>Created procedures relating to the company's facilities.</li>
                            </ul>
                        </div>
                        <div className="work-exp-job-image">
                            <img src="./img/bosch-logo.png" alt="bosch-logo"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="work-exp-job-container mt-5">
                <div className="work-exp-job-content">
                    <div className="work-exp-job-item item--2">
                        ...
                        <div className="work-exp-job-image">
                            <img src="./img/cybersoft-academy-logo.png" alt="cybersoft-academy-logo"/>
                        </div>
                    </div>
                </div>
            </div>
